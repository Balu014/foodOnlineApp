...
@Component({
  selector: 'app-best-in-town',
  templateUrl: './best-in-town.component.html',
  styleUrls: ['./best-in-town.component.css']
})
export class BestInTownComponent implements OnInit {
  ...
  menu = [
    {
      menu_id: 51,
      img:"./assets/images/cbfam.jpg",
      cost:899,
      dish:"Family Pack Chicken Biryani",
      quantity:1,
      ratings:4.6
    },
    {
      menu_id: 52,
      img:"./assets/images/butternan.jpg",
      cost:79,
      dish:"Butter Naan",
      quantity:1,
      ratings:4.4
    ...
    {
      menu_id: 53,
      img:"./assets/images/pudinack.jpg",
      cost:259,
      dish:"Pudina Chicken(Dry)",
      quantity:1,
      ratings:4.2
    },
    {
      menu_id: 54,
      img:"./assets/images/tomsoup.jpg",
      cost:150,
      dish:"Tomato Soup",
      quantity:1,
      ratings:3.9
    ...
    {
      menu_id: 55,
      img:"./assets/images/ckctika.jpg",
      cost:499,
      dish:"Chicken Tangdi Kebab",
      quantity:1,
      ratings:4.1
    },
    {
      menu_id: 56,
      img:"./assets/images/eggnod.jpg",
      cost:200,
      dish:"Special Egg Noddles",
      quantity:1,
      ratings:3.8
    },
    {
      menu_id: 57,
      img:"./assets/images/crudrice.jpg",
      cost:119,
      dish:"Crud Rice",
      quantity:1,
      ratings:4.6
