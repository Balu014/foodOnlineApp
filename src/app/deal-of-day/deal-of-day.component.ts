...
export class DealOfDayComponent implements OnInit {
  ...
  menu = [
    {
      menu_id: 61,
      img:"./assets/images/arbainman.jpg",
      cost:600,
      dish:"Arabian Chicken Mandi ",
      quantity:1,
      ratings:4.6
    },
    {
      menu_id: 62,
      img:"./assets/images/gobimb.jpg",
      cost:200,
      dish:"Gobi Fried Rice",
      quantity:1,
      ratings:4.4
    },
    {
      menu_id: 63,
      img:"./assets/images/bbqman.jpg",
      cost:450,
      dish:"BBQ Chicken Mandi Medium",
      quantity:1,
      ratings:4.2
    },
    {
      menu_id: 64,
      img:"./assets/images/hydckc.jpg",
      cost:350,
      dish:"Hyderabad Chick Dum Biriyani",
      quantity:1,
      ratings:3.9
    },
    {
      menu_id: 65,
      img:"./assets/images/gobibir.jpg",
      cost:230,
      dish:"Mushroom Fried Rice",
      quantity:1,
      ratings:4.1
    }
  ];
